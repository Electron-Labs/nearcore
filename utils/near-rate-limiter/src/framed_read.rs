...
pub struct ThrottleController {
    ...
    max_record_num_messages_in_progress: Arc<AtomicUsize>,
...
impl ThrottleController {
    ...
    pub fn new(
        ...
        Self {
            ...
            max_record_num_messages_in_progress: Default::default(),
    ...
    pub fn add_msg(&self, msg_size: usize) {
        let new_cnt = self.num_messages_in_progress.fetch_add(1, Ordering::SeqCst);
        self.max_record_num_messages_in_progress.fetch_max(new_cnt, Ordering::Relaxed);
        if msg_size != 0 {
    ...
    pub fn consume_max_record_num_messages_in_progress(&mut self) -> usize {
        self.max_record_num_messages_in_progress.swap(0, Ordering::Relaxed)
    }
}
